$.AmsApproval = {
    ...
    init:function(){
        var autoQuery = false;
        if ($("#amsApproval_master").length>0){
            if ($("#amsApproval_master").panel("options").region=="north"){
                $("#amsApproval_master").panel("resize",{height:document.body.clientHeight});
            }else{
                $("#amsApproval_master").panel("resize",{width:document.body.clientWidth});
            }
        }
