jQuery.AmsArchiveGrid = {
    column:[[
        {field:'daglId',checkbox:true,hidden:true},
        {field:'storagePlace',align:'center',halign:'center',title:'存放位置',hidden:true},
        {field:'storagePlaceShowLabel',width:100,align:'left',halign:'center',title:'存放位置',sortable: true},
    ...
    queryParams:function(grid){
        ...
        return {
            ...
            'idName' : $.totemUtils.getQueryValue($(formName+ " [name='idName']")),
            'noIdName' : $.totemUtils.getQueryValue($(formName+ " [name='noIdName']")),
            ...
            'storagePlace' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_StoragePlace']")),
            'orgNo' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_OrgNo']")),
            'arcNo' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_ArcNo']")),
            'consNo' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_ConsNo']")),
            'appNo' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_AppNo']")),
            'busiClass' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_BusiClass']")),
            'busiType' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_BusiType']")),
            'idNo' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_IdNo']")),
            'hasFile' : $.totemUtils.getQueryValue($(formName+ " [name='amsArchive_HasFile']"))
        }
    }
}
