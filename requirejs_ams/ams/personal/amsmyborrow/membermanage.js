$.AmsMyBorrow = {
    ...
    init:function(){
        var autoQuery = false;
        if ($("#amsMyBorrow_master").length>0){
            if ($("#amsMyBorrow_master").panel("options").region=="north"){
                $("#amsMyBorrow_master").panel("resize",{height:document.body.clientHeight});
            }else{
                $("#amsMyBorrow_master").panel("resize",{width:document.body.clientWidth});
            }
        }
