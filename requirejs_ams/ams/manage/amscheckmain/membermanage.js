$.AmsCheckMain = {
    ...
    init:function(){
        var autoQuery = false;
        if ($("#amsCheckMain_master").length>0){
            if ($("#amsCheckMain_master").panel("options").region=="north"){
                $("#amsCheckMain_master").panel("resize",{height:document.body.clientHeight});
            }else{
                $("#amsCheckMain_master").panel("resize",{width:document.body.clientWidth});
            }
        }
