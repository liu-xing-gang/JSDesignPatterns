$.AmsMove = {
    ...
    init:function(){
        var autoQuery = false;
        if ($("#amsMove_master").length>0){
            if ($("#amsMove_master").panel("options").region=="north"){
                $("#amsMove_master").panel("resize",{height:document.body.clientHeight});
            }else{
                $("#amsMove_master").panel("resize",{width:document.body.clientWidth});
            }
        }
