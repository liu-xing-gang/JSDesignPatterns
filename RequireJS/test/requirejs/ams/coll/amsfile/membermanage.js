$.AmsFile = {
    ...
    init:function(){
        var autoQuery = false;
        if ($("#amsFile_master").length>0){
            if ($("#amsFile_master").panel("options").region=="north"){
                $("#amsFile_master").panel("resize",{height:document.body.clientHeight});
            }else{
                $("#amsFile_master").panel("resize",{width:document.body.clientWidth});
            }
        }
